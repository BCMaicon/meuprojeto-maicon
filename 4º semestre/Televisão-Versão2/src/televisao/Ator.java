...
public class Ator {
    ...
    public Integer getN_eventos() {
        return n_eventos;
    }

    public void setN_eventos(Integer n_eventos) {
    ...
    public String Status() {
     ...
     public double Ganhos(double ganhos ){
         
          
          ganhos = (n_eventos * cache_part) + (sal_mensal);
          return ganhos;
     } 
